...
module.exports = {
  ...
  theme: {
    ...
    backgroundImage: ({ theme }) => ({
      ...
      "gradient-neutral": "linear-gradient(310deg," + theme("colors.neutral.600") + "," + theme("colors.neutral.300") + ")",
      "gradient-dark-gray": "linear-gradient(310deg," + theme("colors.gray.900") + "," + theme("colors.neutral.800") + ")",
    ...
    fontFamily: {
      sans: ["Inter"],
      serif: ["ui-monospace",'SFMono-Regular, Menlo, Monaco, Consolas, "Liberation Mono", "Courier New", monospace', "serif"],
      body: ["Inter", "sans-serif"],
      awesome: ["FontAwesome"],
      h1: ["Outfit", "sans-serif"],
      h2: ["Outfit", "sans-serif"],
      h3: ["Outfit", "sans-serif"],
      h4: ["Outfit", "sans-serif"],
      h5: ["Outfit", "sans-serif"],
      h6: ["Outfit", "sans-serif"],
    },
    fontSize: ({ theme }) => ({
      ...theme("spacing"),
      inherit: "inherit",
    ...
    ringColor: ({ theme }) => ({
      DEFAULT: theme("colors.green.700", "#15803d"),
      ...theme("colors"),
    }),
